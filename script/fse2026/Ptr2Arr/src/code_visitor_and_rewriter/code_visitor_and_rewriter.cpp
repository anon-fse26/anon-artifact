                ...
                if (VD->hasInit()) {
                    ...
                    if (initExprStr == "NULL") {
                        ...
                        if (isMulti) {
                            ...
                            std::string textToReplace = "int " + varName;
                            TheRewriter.ReplaceText(clang::SourceRange(VD->getBeginLoc(), VD->getLocation()), textToReplace);
                        }
                        ...
                        TheRewriter.ReplaceText(
                            clang::CharSourceRange::getCharRange(
                                ...
                                clang::Lexer::getLocForEndOfToken(initExpr->getEndLoc(), 0, SM, TheRewriter.getLangOpts())),
                            textToReplace);
